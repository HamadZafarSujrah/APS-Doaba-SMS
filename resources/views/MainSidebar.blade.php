				...
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				   ...
				   with font-awesome or any other icon font library -->
					<li class="nav-item menu-open">
						<a href="admissionform" class="nav-link active"> <i class="nav-icon fas fa-tachometer-alt"></i>
					...
					<li class="nav-item">
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"> <i class="far fa-circle nav-icon"></i> <a href="admissionform"><i class="fa fa-graduation-cap"></i> {{ ('Studemt Enrollement') }}</a> </li>
